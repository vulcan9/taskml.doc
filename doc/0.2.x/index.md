...
기타 파일 참고
* [app_importmap.js](https://github.com/vulcan9/taskml.doc/tree/main/doc/0.2.x/dist/taskml/app_importmap.js)
* [SvgLine.js](https://github.com/vulcan9/taskml.doc/tree/main/doc/0.2.x/dist/taskml/SvgLine.js)
...
* ~~화면을 구성하는 DOM 컴포넌트~~ (사용안함)

> v 0.2.0 버전부터 0.1.x 버전의 DOM 컴포넌트는 사용하지 않습니다.  
> `task` 인터페이스를 통한 인터렉션과 흐름제어만 담당합니다.
