...
function Dt(i, t = {}, e, r) {
  const n = {};
  return r || pr(() => n.children = Ar(i, t.children, n.children)), pr(() => t.ref && t.ref(i)), pr(() => Gl(i, t, e, !0, n, !0)), n;
}
function hi(i, t, e) {
  return mn(() => i(t, e));
}
...
const Kl = "is", Ql = "-", Ne = ["task", "as-task"], xr = "task:", Ta = "component-type";
function ba(i, t = Kl) {
  return t = t ? t + Ql : "", t + i;
}
...
function Kr(i, t = /* @__PURE__ */ new Set()) {
  let e, r, n, s;
  if (e = i != null && i[Xi])
    return e;
  if (!jn(i) || t.has(i))
  ...
  if (Array.isArray(i)) {
    ...
    for (let u = 0, l = o.length; u < l; u++)
      s = o[u], !a[s].get && (n = i[s], (r = Kr(n, t)) !== n && (i[s] = r));
  }
  return i;
}
function Bn(i, t) {
...
const tc = {
  get(i, t, e) {
    ...
    if (!n) {
      ...
      Hi() && (typeof s != "function" || i.hasOwnProperty(t)) && !(o && o.get) && (s = Qr(r, t, s)());
    }
    return jn(s) ? $a(s) : s;
  },
  has(i, t) {
    return t === Xi || t === Wt || t === co || t === mr || t === Qt || t === "__proto__" ? !0 : (Hi() && Qr(Bn(i, Qt), t)(), t in i);
  },
  set() {
    return !0;
  },
...
function Vn(i, t, e, r = !1) {
  ...
  let o = Bn(i, mr), a;
  if ((a = Qr(o, t, n)) && a.$(() => e), Array.isArray(i) && i.length !== s) {
    for (let u = i.length; u < s; u++)
      (a = o[u]) && a.$();
    (a = Qr(o, "length", s)) && a.$(i.length);
  }
  (a = o[Ea]) && a.$();
}
function xa(i, t) {
...
function ec(i, t) {
  if (typeof t == "function" && (t = t(i)), t = Kr(t), Array.isArray(t)) {
    if (i === t)
      return;
    let e = 0, r = t.length;
    for (; e < r; e++) {
...
function Vr(i, t, e = []) {
  ...
  let s = t[0];
  typeof s == "function" && (s = s(n, e), s === n) || r === void 0 && s == null || (s = Kr(s), r === void 0 || jn(n) && jn(s) && !Array.isArray(s) ? xa(n, s) : Vn(i, r, s));
}
function rc(...[i, t]) {
  const e = Kr(i || {}), r = Array.isArray(e), n = $a(e);
  function s(...o) {
    bl(() => {
      r && o.length === 1 ? ec(e, o[0]) : Vr(e, o);
    });
  }
  return [n, s];
}
...
function ac(i) {
  ...
  if ((t == null ? void 0 : t.length) > 0)
    return i = i.replace(_o, (a, u) => u), Hr(i);
  const r = i.match(Ki);
  if ((r == null ? void 0 : r.length) > 0)
    return i = i.replace(Ki, (a, u) => "`" + a + "`"), Hr(i);
  const s = i.match(Qi);
...
class lc {
  ...
  onDragOver(t) {
    this.dndID === this.getAttribute($t, Sr) && t.preventDefault();
  }
  onDrop(t) {
    const e = this.getAttribute($t, Sr);
    if (this.dndID !== e)
      return;
    t.preventDefault();
...
class cc {
  ...
  dispatchEvent(t, e, r) {
    ...
    if (this.dropArea && (n.dropValue = this.dropArea.getAttribute(Un), n.dropGroup = this.dropArea.getAttribute(Sr), n.drop = this.dropArea), n.success = this.dragValue === n.dropValue, e.dispatchEvent(new CustomEvent(t, {
      detail: n,
...
const Sr = "data-dnd-group", qn = "data-drag-value", Un = "data-drop-value", fc = "data-dnd-type", hc = "as-dnd-mode";
class dc extends Da {
  constructor() {
    super(...arguments);
    x(this, "dndID");
...
class gc extends Ma {
  ...
  toggleFullScreen(e) {
    ...
    if (e ? typeof e == "string" ? r = document.querySelector(e) : r = e : r = this.player, !!r) {
      ...
      if (r === this.player && E(this, un) === void 0 && (O(this, un, r.controls), r.controls = !0), r.requestFullscreen)
        r.requestFullscreen();
...
xt = new WeakMap(), Fe = new WeakMap(), un = new WeakMap();
var Zt;
class _c {
  constructor(t) {
    x(this, "player");
...
class Lr {
  ...
  copy() {
    ...
    return structuredClone ? t = structuredClone(t) : t = JSON.parse(JSON.stringify(t)), t.parseOption = this.parseOption, t.list = this.list.map((e) => e.copy()), new Lr(t);
  }
}
class Jr {
  ...
  copy() {
    ...
    return structuredClone ? t = structuredClone(t) : t = JSON.parse(JSON.stringify(t)), t._args = this._args, t.parseOption = this.parseOption, new Jr(t);
  }
}
function Lc(i, ...t) {
  return (...e) => i(...t, ...e);
...
var zr;
Rc ? zr = queueMicrotask : Ra ? zr = setImmediate : Na ? zr = process.nextTick : zr = Ia;
const Je = Fa(zr);
function Ji(i) {
...
const Ba = L(Qc, 3), Jc = ja(Ba), Rr = Symbol("promiseCallback");
function Or() {
  let i, t;
  function e(r, ...n) {
    if (r)
  ...
  return e[Rr] = new Promise((r, n) => {
    i = r, t = n;
  }), e;
}
function Va(i, t, e) {
  typeof t != "number" && (e = t, t = null), e = $e(e || Or());
...
function za(...i) {
  ...
  return function(...e) {
    ...
    return typeof n == "function" ? e.pop() : n = Or(), Wr(
      t,
      e,
      (s, o, a) => {
...
function is(i, t, e) {
  ...
  if (arguments.length < 3 && typeof i == "function" ? (e = t || Or(), t = i) : (sh(r, i), e = e || Or()), typeof t != "function")
...
function oh(i, t) {
  ...
  var r = R(t);
  return wn((n, s) => {
    (n.length < e - 1 || s == null) && (n.push(s), s = Or());
    function o(a) {
      r(...n, a);
    }
    return i ? is(i, o, s) : is(o, s), s[Rr];
  });
}
function ah(i, t) {
  return Cs(ne, i, t);
...
function _h(i, t, e, r) {
  arguments.length <= 3 && typeof t == "function" && (r = e, e = t, t = Array.isArray(i) ? [] : {}), r = $e(r || Or());
  var n = R(e);
  return It(i, (s, o, a) => {
    n(t, s, o, a);
  }, (s) => r(s, t)), r[Rr];
...
var Ve, ln, le, ce, fe, vr, wr, Vt, ze, qe, Tr, ii, Ka;
const uo = class uo {
  constructor(t) {
    /*
  ...
  setOptions(t) {
    if (O(this, ln, t.provider), O(this, fe, t.shadowrootMode), E(this, fe) === "" && O(this, fe, "open"), O(this, ce, t.parent), E(this, fe) && !E(this, ce))
...
Ve = new WeakMap(), ln = new WeakMap(), le = new WeakMap(), ce = new WeakMap(), fe = new WeakMap(), vr = new WeakMap(), wr = new WeakMap(), Vt = new WeakMap(), ze = new WeakMap(), qe = new WeakMap(), Tr = new WeakMap(), ii = new WeakSet(), Ka = function(t) {
...
let Fr;
function yi(i) {
  Fr || (Fr = document.createElement("template"), Fr.setAttribute(kh, ""), document.body.append(Fr));
  const t = Fr, e = `[${Yn}="${i.ns}"]`;
...
function zh(i, t) {
  ...
  const e = i instanceof Lr ? i.copy() : i;
  if (!e)
    return;
  const { src: r } = e.attrs;
  if (!r)
...
function Uh(i) {
  ...
  return (e === "js" || e === "script") && (t.$script = i.innerHTML), k() && console.log("		- item: ", e, t), new Jr({
    nodeName: e,
    attrs: t,
...
function Hh(i) {
  ...
  return n ? (r && (s.provider.$task.add(r, n), delete e.id), k() && console.log("		- item (src): ", t, e), new Jr({
    nodeName: t,
    attrs: e,
    parseOption: s
  })) : (r || (r = Wh(), i.setAttribute("id", r)), Ja(i), e.src = r, delete e.id, k() && console.log("		- item (ref): ", t, e), new Jr({
    nodeName: t,
    attrs: e,
    parseOption: s
  }));
...
function ed(i) {
  i.forEach((t) => {
    ...
    if (t.type !== "attributes")
      return;
    const e = t.target, r = t.attributeName, n = r.startsWith(xr);
...
function nd(i, t) {
  ...
  if (!(e != null && e[t]))
    return;
  let r;
  t.startsWith("on") ? r = t.substring(2) : r = t.substring(xr.length);
  const { handler: n } = e[t];
...
function tu(i, t) {
  ...
  return e = e.toLowerCase(), e.startsWith("on") ? (o = qo(i, n, !1), zo(i, e, o, e), {
    name: e,
    value: o
  }) : e.startsWith(xr) ? (s = e.substring(xr.length), s ? (o = qo(i, n, !0), zo(i, `on${s}`, o, e), {
    name: e,
    value: e
  }) : t) : t;
}
...
class ru extends Ma {
  ...
  create({
    ...
    return this.debug = k(), this.depth = !s || isNaN(s) ? 0 : s, this.tab = this.debug ? Sh(s + 1) : "", O(this, cn, e), O(this, fn, r), O(this, hn, n), this;
  }
  //--------------------------------------
  // Task 진행 Flow
  //--------------------------------------
  ...
  checkComplete() {
    E(this, br) && E(this, Er) && (this.completeEvent(), this.destroy(), this.completeTask());
  }
  //--------------------------------------
  // Task 진행 이벤트 - start
  //--------------------------------------
  startEvent() {
    O(this, br, !1), O(this, Er, !1), this.emit("start", this);
  }
  startTask(e) {
    const r = () => {
      O(this, br, !0), e(), this.checkComplete();
    };
  ...
  attributeEvent(e, r = null, n = !1) {
    ...
    try {
      ...
      o && Ca(this.args, o);
      const a = xr + s, u = this.info.attrs[a];
      if (!u)
...
cn = new WeakMap(), fn = new WeakMap(), hn = new WeakMap(), br = new WeakMap(), Er = new WeakMap();
j("TaskInterface", ru);
class ud extends ru {
  dynamic(t) {
...
function os(i, t, e, r) {
  ...
  let o;
  s ? o = Pa(t, s) : o = t;
  const a = yn(t, n), u = (_ = (p = (h = t == null ? void 0 : t.event) == null ? void 0 : h.target) == null ? void 0 : p.getParseOption) == null ? void 0 : _.call(p);
  if (!u)
    return;
...
class zs extends ht {
  ...
  run(e, r, n) {
    ...
    if (l) {
      O(this, Xe, l.dom), O(this, $r, l.media), l.destroy.push(super.destroy.bind(this)), this.execuate(e, r, n), n(!1);
      return;
    }
    if (this.setDoms(), (c = this.doms) != null && c[0] ? O(this, Xe, this.doms[0]) : O(this, Xe, this.createDOM(this.mediaType)), O(this, $r, this.createMedia(this.mediaType)), !this.media)
...
var Tt = {
  ...
  return t._repeat ? Pr(t._tTime, t = t.duration() + t._rDelay) * t : 0;
}, Pr = function(t, e) {
  ...
  if (a && t._repeat && (u = $n(0, t._tDur, e), c = Pr(u, a), t._yoyo && c & 1 && (o = 1 - o), c !== Pr(t._tTime, a) && (s = 1 - o, t.vars.repeatRefresh && t._initted && t.invalidate())), o !== s || at || n || t._zTime === q || !e && t._zTime) {
  ...
  return t instanceof ft ? tr(t) : Cr(t, t._dur);
}, Wp = {
  _start: 0,
  endTime: en,
  totalDuration: en
  ...
  return W && !e && W.selector ? W.selector(t) : nt(t) && !r && (fs || !Dr()) ? ms.call((e || Gs).querySelectorAll(t), 0) : ut(t) ? Yp(t, r) : Mu(t) ? ms.call(t, 0) : t ? [t] : [];
}, gs = function(t) {
  return t = Ot(t)[0] || tn("Invalid scope") || {}, function(e) {
    var r = t.current || t.nativeElement || t;
    return Ot(e, r.querySelectorAll ? r : r === t ? tn("Invalid scope") || Gs.createElement("div") : t);
  };
}, Lu = function(t) {
  ...
  var n = t ? ie(t) ? [t >> 16, t >> 8 & B, t & B] : 0 : Ur.black, s, o, a, u, l, c, f, h, p, _;
  if (!n) {
    if (t.substr(-1) === "," && (t = t.substr(0, t.length - 1)), Ur[t])
      n = Ur[t];
    else if (t.charAt(0) === "#") {
  ...
  return f = {
    ...
    sleep: function() {
      (c ? cancelAnimationFrame : clearTimeout)(u), nn = 0, l = en;
    },
    ...
    add: function(y, w, m) {
      ...
      return f.remove(y), a[m ? "unshift" : "push"](g), Dr(), g;
    },
    remove: function(y, w) {
...
var Yu = function(t, e) {
  ...
  function i(e) {
    this.vars = e, this._delay = +e.delay || 0, (this._repeat = e.repeat === 1 / 0 ? -2 : e.repeat || 0) && (this._rDelay = e.repeatDelay || 0, this._yoyo = !!e.yoyo || !!e.yoyoEase), this._ts = 1, Cr(this, +e.duration, 1, 1), this.data = e.data, W && (this._ctx = W, W.data.push(this)), nn || vt.wake();
  }
  var t = i.prototype;
  return t.delay = function(r) {
    ...
    return arguments.length ? this.totalTime(this._time + (r - 1) * s, n) : this._repeat ? Pr(this._tTime, s) + 1 : 1;
...
var ft = /* @__PURE__ */ function(i) {
  ...
  return e.to = function(n, s, o) {
    ...
    return s.duration = 0, s.parent = this, Gr(s).repeatDelay || (s.repeat = 0), s.immediateRender = !!s.immediateRender, new Z(n, s, At(this, o), 1), this;
    ...
    return o.runBackwards = 1, Gr(o).immediateRender = dt(o.immediateRender), this.staggerTo(n, s, o, a, u, l, c);
  }, e.staggerFromTo = function(n, s, o, a, u, l, c, f) {
    return a.startAt = o, Gr(a).immediateRender = dt(a.immediateRender), this.staggerTo(n, s, a, u, l, c, f);
    ...
    if (this !== Y && c > u && n >= 0 && (c = u), c !== this._tTime || o || f) {
      if (a !== this._time && l && (c += this._time - a, n += this._time - a), h = c, v = this._start, g = this._ts, w = !g, f && (l || (a = this._zTime), (n || !s) && (this._zTime = n)), this._repeat) {
        ...
        if (h = rt(c % y), c === u ? (d = this._repeat, h = l) : (d = ~~(c / y), d && d === c / y && (h = l, d--), h > l && (h = l)), T = Pr(this._tTime, y), !a && this._tTime && T !== d && this._tTime - T * y - this._dur <= 0 && (T = d), b && d & 1 && (h = l - h, $ = 1), d !== T && !this._lock) {
    ...
    var o = this;
    if (ie(s) || (s = At(this, s, n)), !(n instanceof sn)) {
      if (ut(n))
    ...
    var o = this, a = At(o, n), u = s, l = u.startAt, c = u.onStart, f = u.onStartParams, h = u.immediateRender, p, _ = Z.to(o, Pt({
      ...
      onStart: function() {
        if (o.pause(), !p) {
          ...
          _._dur !== y && Cr(_, y, 0, 1).render(_._time, !0, !0), p = 1;
        }
        c && c.apply(_, f || []);
      }
    }, s));
    ...
    if (o._dirty) {
      ...
      Cr(o, o === Y && o._time > s ? o._time : s, 1, 1), o._dirty = 0;
    }
    return o._tDur;
...
var am = function(t, e, r, n, s, o, a) {
  ...
  for (u.b = r, u.e = n, r += "", n += "", (w = ~n.indexOf("random(")) && (n = rn(n)), o && (m = [r, n], o(m, t, e), r = m[0], n = m[1]), h = r.match(Ni) || []; f = Ni.exec(n); )
  ...
  if (nt(n) && (~n.indexOf("random(") && (n = rn(n)), n.charAt(1) === "=" && (_ = gr(h, n) + (st(h) || 0), (_ || _ === 0) && (n = _))), !c || h !== n || ys)
  ...
  if (K(t) && (t = Xr(t, s, e, r, n)), !Gt(t) || t.style && t.nodeType || ut(t) || _u(t))
    return nt(t) ? Xr(t, s, e, r, n) : t;
  var o = {}, a;
  for (a in t)
    o[a] = Xr(t[a], s, e, r, n);
  return o;
  ...
  if (v && (!h || !s) && (s = "none"), t._ease = er(s, kr.ease), t._yEase = f ? Hu(er(f === !0 ? s : f, kr.ease)) : 0, f && t._yoyo && !t._repeat && (f = t._yEase, t._yEase = t._ease, t._ease = f), t._from = !v && !!n.runBackwards, !v || h && !n.stagger) {
    ...
    for (l = t._ptCache[e] = [], h = t._ptLookup, p = t._targets.length; p--; ) {
      if (c = h[p][e], c && c.d && c.d._pt)
        for (c = c.d._pt; c && c.p !== e && c.fp !== e; )
          c = c._next;
      if (!c)
        return ys = 1, t.vars[e] = "+=0", Zs(t, a), ys = 0, u ? tn(e + " not eligible for reset") : 1;
      l.push(c);
    }
  for (p = l.length; p--; )
...
}, Xr = function(t, e, r, n, s) {
  return K(t) ? t.call(e, r, n, s) : nt(t) && ~t.indexOf("random(") ? rn(t) : t;
...
var Z = /* @__PURE__ */ function(i) {
  ...
  function t(r, n, s, o) {
    var a;
    typeof n == "number" && (s.duration = n, n = s, s = null), a = i.call(this, o ? n : Gr(n)) || this;
    ...
    if (a._targets = g.length ? Qs(g) : tn("GSAP target " + r + " not found. https://gsap.com", !Tt.nullTargetWarn) || [], a._ptLookup = [], a._overwrite = p, _ || h || On(l) || On(c)) {
      if (n = a.vars, v = a.timeline = new ft({
        ...
        for (T = 0; T < $; T++)
          b = Jn(n, Qu), b.stagger = 0, w && (b.yoyoEase = w), F && nr(b, F), A = g[T], b.duration = +Xr(l, Kt(a), T, A, g), b.delay = (+Xr(c, Kt(a), T, A, g) || 0) - a._delay, !h && $ === 1 && b.delay && (a._delay = c = b.delay, a._start += c, b.delay = 0), v.to(A, b, M ? M(T, A, g) : 0), v._ease = N.none;
        v.duration() ? l = c = 0 : a.timeline = 0;
      } else if (_) {
        Gr(Pt(v.vars.defaults, {
          ease: "none"
  ...
  return e.render = function(n, s, o) {
    ...
    if (!l)
      ...
      if (h = f, g = this.timeline, this._repeat) {
        ...
        if (h = rt(f % d), f === u ? (_ = this._repeat, h = l) : (_ = ~~(f / d), _ && _ === rt(f / d) && (h = l, _--), h > l && (h = l)), w = this._yoyo && _ & 1, w && (v = this._yEase, h = l - h), y = Pr(this._tTime, d), h === a && !o && this._initted && _ === y)
    ...
    if (s === void 0 && (s = "all"), !n && (!s || s === "all"))
      return this._lazy = this._pt = 0, this.parent ? qr(this) : this;
    if (this.timeline) {
      var o = this.timeline.totalDuration();
      return this.timeline.killTweensOf(n, s, ge && ge.vars.overwrite !== !0)._first || qr(this), this.parent && o !== this.timeline.totalDuration() && Cr(this, this._dur * this.timeline._tDur / o, 0, 1), this;
    }
...
var rr = [], Mn = {}, ym = [], ia = 0, vm = 0, Vi = function(t) {
  ...
  defaults: function(t) {
    return t && t.ease && (t.ease = er(t.ease, kr.ease)), Zo(kr, t || {});
  },
  config: function(t) {
    return Zo(Tt, t || {});
  },
  registerEffect: function(t) {
    ...
    (n || "").split(",").forEach(function(a) {
      return a && !yt[a] && !Et[a] && tn(e + " effect requires " + a + " plugin.");
    }), Ii[e] = function(a, u, l) {
...
var sa, _e, _r, no, Ie, oa, io, Em = function() {
  ...
  return n[e] || n.getPropertyValue(e.replace(so, "-$1").toLowerCase()) || n.getPropertyValue(e) || !r && i(t, Mr(e) || e, 1) || "";
}, ua = "O,Moz,ms,Ms,Webkit".split(","), Mr = function(t, e, r) {
  ...
  Em() && window.document && (sa = window, _e = sa.document, _r = _e.documentElement, Ie = Ts("div") || {
    style: {}
  }, Ts("div"), X = Mr(X), gt = X + "Origin", Ie.style.cssText = "border-width:0;line-height:0;position:absolute;padding:0", al = !!Mr("perspective"), io = _t.core.reverting, no = 1);
}, qi = function i(t) {
  ...
  var s;
  return no || bs(), e in Ut && e !== "transform" && (e = Ut[e], ~e.indexOf(",") && (e = e.split(",")[0])), se[e] && e !== "transform" ? (s = an(t, n), s = e !== "transformOrigin" ? s[e] : s.svg ? s.origin : ri(Ht(t, gt)) + " " + s.zOrigin + "px") : (s = t.style[e], (!s || s === "auto" || n || ~(s + "").indexOf("calc(")) && (s = ei[e] && ei[e](t, e, r) || Ht(t, e) || Au(t, e) || (e === "opacity" ? 1 : 0))), r && !~(s + "").trim().indexOf(" ") ? be(t, e, s, r) + r : s;
}, Fm = function(t, e, r, n) {
  if (!r || r === "none") {
    var s = Mr(e, t, 1), o = s && Ht(t, s, 1);
  ...
  if (e.tween && e.tween._time === e.tween._dur) {
    ...
    u && (ir(r, X), o && (o.svg && r.removeAttribute("transform"), an(r, 1), o.uncache = 1, sl(n)));
  }
}, ei = {
  ...
  */
}, on = [1, 0, 0, 1, 0, 0], cl = {}, fl = function(t) {
  return t === "matrix(1, 0, 0, 1, 0, 0)" || t === "none" || !t;
}, ha = function(t) {
  var e = Ht(t, X);
  return fl(e) ? on : e.substr(7).match(yu).map(Q);
}, oo = function(t, e) {
  var r = t._gsap || Ze(t), n = t.style, s = ha(t), o, a, u, l;
  return r.svg && t.getAttribute("transform") ? (u = t.transform.baseVal.consolidate().matrix, s = [u.a, u.b, u.c, u.d, u.e, u.f], s.join(",") === "1,0,0,1,0,0" ? on : s) : (s === on && !t.offsetParent && t !== _r && !r.svg && (u = n.display, n.display = "block", o = t.parentNode, (!o || !t.offsetParent) && (l = 1, a = t.nextElementSibling, _r.appendChild(t)), s = ha(t), u ? n.display = u : ir(t, "display"), l && (a ? o.insertBefore(t, a) : o ? o.appendChild(t) : _r.removeChild(t))), e && s.length > 6 ? [s[0], s[1], s[4], s[5], s[12], s[13]] : s);
...
}, Me = "0deg", Br = "0px", Le = ") ", hl = function(t, e) {
  ...
  y !== Br && (v += "perspective(" + y + Le), (n || s) && (v += "translate(" + n + "%, " + s + "%) "), (T || o !== Br || a !== Br || u !== Br) && (v += u !== Br || T ? "translate3d(" + o + ", " + a + ", " + u + ") " : "translate(" + o + ", " + a + Le), l !== Me && (v += "rotate(" + l + Le), c !== Me && (v += "rotateY(" + c + Le), f !== Me && (v += "rotateX(" + f + Le), (h !== Me || p !== Me) && (v += "skew(" + h + ", " + p + Le), (_ !== 1 || d !== 1) && (v += "scale(" + _ + ", " + d + Le), m.style[X] = v || "translate(0, 0)";
}, zm = function(t, e) {
  ...
  n.svg ? (l = r.getAttribute("transform"), r.setAttribute("transform", ""), o[X] = e, a = an(r, 1), ir(r, X), r.setAttribute("transform", l)) : (l = getComputedStyle(r)[X], o[X] = e, a = an(r, 1), o[X] = l);
  for (u in se)
  ...
  init: function(t, e, r, n, s) {
    ...
    for (d in e)
      if (d !== "autoRound" && (c = e[d], !(yt[d] && Xu(d, e, r, n, t, s)))) {
        if (p = typeof c, _ = ei[d], p === "function" && (c = c.call(r, n, t, s), p = typeof c), p === "string" && ~c.indexOf("random(") && (c = rn(c)), _)
          _(this, t, d, c, r) && ($ = 1);
...
async function Xm(i = "#app", t = !1) {
  return await (async (r) => {
    ...
    const o = D.createProvider(), a = new Zr({
      owner: window.location.href,
      parent: s,
      provider: o
    });
